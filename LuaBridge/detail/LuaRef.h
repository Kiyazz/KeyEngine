...
public:
    ...
    */
    ...
    //----------------------------------------------------------------------------
    /**
        Access the base reference number for hashing

        @return The m_ref internal number for hashing use as a positive

    */
    size_t get_m_ref() const {
        return static_cast<size_t>(m_ref);
    }
